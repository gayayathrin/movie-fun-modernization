...
public class SetupController {
    ...
    public String setup(Map<String, Object> model) {
        System.out.println("Inside setup controller setup method::");
        ...
        System.out.println("after put of movies");
        model.put("albums", albumsClient.getAlbums());
        System.out.println("after put of albums");
        System.out.println("End of setup controller setup method::");
        return "setup";
    }
}